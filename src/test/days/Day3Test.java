...
class Day3Test {
    ...
    void testDay3ex() throws IOException {
        long s = Day3.day3(Util.readFromFile("day3ex.txt"));
    ...
    void testDay3() throws IOException {
        long s = Day3.day3(Util.readFromFile("day3.txt"));
    ...
    void testDay3exLevel2() throws IOException {
        long s = Day3.day3Level2(Util.readFromFile("day3ex.txt"));

        assertEquals(230, s);
    }
    @Test
    void testDay3Level2() throws IOException {
        long s = Day3.day3Level2(Util.readFromFile("day3.txt"));
