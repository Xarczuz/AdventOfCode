...
class Day4Test {
    ...
    void bingo1ex() throws IOException {
        int res = new Day4().bingo1(Util.readFromFile("day4ex.txt"));
    ...
    void bingo1() throws IOException {
        int res = new Day4().bingo1(Util.readFromFile("day4.txt"));

        assertEquals(31424, res);
    }
    @Test
    void bingo2ex() throws IOException {
        int res = new Day4().bingo2(Util.readFromFile("day4ex.txt"));
    ...
    void bingo2() throws IOException {
        int res = new Day4().bingo2(Util.readFromFile("day4.txt"));
