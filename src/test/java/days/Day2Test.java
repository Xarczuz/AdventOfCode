...
class Day2Test {
    ...
    void testDay2() throws IOException {
        long res = new Day2().day2(Util.readFromFile(("day2.txt")));
        assertEquals(2091984,res);
    }

    @Test
    void testDay2ex() throws IOException {
        long res = new Day2().day2(Util.readFromFile(("day2ex.txt")));
        assertEquals(150,res);
    }

    @Test
    void testDay2Level2() throws IOException {
        long res = new Day2().day2Level2(Util.readFromFile(("day2.txt")));
