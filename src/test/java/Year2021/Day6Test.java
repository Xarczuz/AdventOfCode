...
import adventOfCode.Year2021.Day6;
import classes.Fish;
...
class Day6Test {
    ...
    void testLanternfish1ex() throws IOException {
        long fishes = new Day6().Lanternfish1(FileUtil.readFromFile("adventOfCode/Year2021/day6ex.txt"), 80);
        assertEquals(5934, fishes);
    }

    @Test
    void testLanternfish1() throws IOException {
        long fishes = new Day6().Lanternfish1(FileUtil.readFromFile("adventOfCode/Year2021/day6.txt"), 80);
        assertEquals(360268, fishes);
    }

    @Test
    void testLanternfish2ex() throws IOException {
        BigInteger fishes = new Day6().Lanternfish2(FileUtil.readFromFile("adventOfCode/Year2021/day6ex.txt"));
        assertEquals("26984457539", fishes.toString());
    }

    @Test
    void testLanternfish2() throws IOException {
        BigInteger fishes = new Day6().Lanternfish2(FileUtil.readFromFile("adventOfCode/Year2021/day6.txt"));
