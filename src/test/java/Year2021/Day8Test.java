...
import adventOfCode.Year2021.Day8;
...
class Day8Test {
    ...
    void testPart1ex() throws IOException {
        int res = new Day8().part1(FileUtil.readFromFile("adventOfCode/Year2021/day8ex.txt"));
        assertEquals(26,res);
    }

    @Test
    void testPart1() throws IOException {
        int res = new Day8().part1(FileUtil.readFromFile("adventOfCode/Year2021/day8.txt"));
        assertEquals(519,res);
    }

    @Test
    void testPart2ex() throws IOException {
        long res = new Day8().part2(FileUtil.readFromFile("adventOfCode/Year2021/day8ex.txt"));
        assertEquals(61229,res);
    }
    @Test
    void testPart2() throws IOException {
        long res = new Day8().part2(FileUtil.readFromFile("adventOfCode/Year2021/day8.txt"));
